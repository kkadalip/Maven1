...
//		p1.setImages(p1images);
		...
		p14.setImagesArray(pg2.getImagesRootFolder() + "/Korterelamu Tallinn Masti", new String[]{"1.jpg","2.jpg","3.jpg","Joonis (1. korrus).jpg","Joonis (2. korrus).jpg"});
		session.save(p14);
		...
		p15.setImagesArray(pg2.getImagesRootFolder() + "/Rekonstruktsioon Tallinn Tööstuse 54a", new String[]{"1.jpg","2.jpg","3.jpg","4.jpg","5.jpg"});
		session.save(p15);
		...
		p16.setImagesArray(pg2.getImagesRootFolder() + "/Kortermajad Tallinn Helme", new String[]{"1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","Joonis (1. korrus).jpg","Joonis (2. korrus).jpg"});
		session.save(p16);
		...
		p17.setImagesArray(pg2.getImagesRootFolder() + "/Rekonstruktioon kortermaja Suur-Patarei 16", new String[]{"1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","Joonis (asendiplaan).jpg","Joonis (plaan).jpg"});
		session.save(p17);
		...
		p21.setImagesArray(pg2.getImagesRootFolder() + "/Büroohoone Tallinn Pärnu mnt 153", new String[]{"1.jpg","2.jpg","3.jpg","4.jpg","Joonis (1. korrus).jpg","Joonis (3. korrus).jpg","Joonis (asendiplaan).jpg","Joonis (katuse plaan).jpg","Joonis (keldrikorrus).jpg"});
		session.save(p21);
		...
		p23.setImagesArray(pg2.getImagesRootFolder() + "/Büroohoone Tallinn Katusepapi 8", new String[]{"1.jpg","2.jpg","3.jpg","Joonis (korruseplaan).jpg"});
		session.save(p23);
		...
		p24.setImagesArray(pg2.getImagesRootFolder() + "/Korterelamu Pärnu Papli 34", new String[]{"1.jpg","2.jpg","3.jpg","4.jpg","Joonis (1. korrus).jpg","Joonis (2. korrus).jpg"});
		session.save(p24);
		...
		p25.setImagesArray(pg2.getImagesRootFolder() + "/Korterelamu Pärnu Papli 34", new String[]{"1.jpg","2.jpg"});
		session.save(p25);
		...
		p26.setImagesArray(pg2.getImagesRootFolder() + "/Korterelamu Tallinn Luige 3", new String[]{"1.jpg","2.jpg","Joonis (asendiplaan).jpg"});
		session.save(p26);
		...
		p27.setImagesArray(pg2.getImagesRootFolder() + "/Korterelamu Tallinn Kaupmehe 12", new String[]{"1.jpg","2.jpg","Joonis (korruseplaan).jpg"});
		session.save(p27);
		...
		p28.setImagesArray(pg3.getImagesRootFolder() + "/Narva Linnus", new String[]{"1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","8.jpg","Joonis (asendiplaan).jpg","Joonis (linnuse plaanid).jpg"});
		session.save(p28);
		...
		p29.setImagesArray(pg3.getImagesRootFolder() + "/Narva Joaoru Puhkeala", new String[]{"1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","Joonis (asendiplaan).jpg","Joonis (rannahoone).jpg","Joonis (valgustuse plaan).jpg"});
		session.save(p29);
		...
		p32.setImagesArray(pg3.getImagesRootFolder() + "/Büroohoone Tallinn", new String[]{"1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","Joonis (makett 1).jpg","Joonis (makett 2).jpg", "Joonis (makett 3).jpg"});
		session.save(p32);
		...
		p33.setImagesArray(pg3.getImagesRootFolder() + "/Maaülikool", new String[]{"1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","8.jpg"});
		session.save(p33);
		...
		p34.setImagesArray(pg3.getImagesRootFolder() + "/G4S", new String[]{"1.jpg","2.jpg","3.jpg","Joonis (asendiplaan).jpg"});
		session.save(p34);
		...
		p36.setImagesArray(pg4.getImagesRootFolder() + "/Narva-Jõesuu Vabaduse 72", new String[]{"1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg"});
		session.save(p36);
		...
		p37.setImagesArray(pg4.getImagesRootFolder() + "/Tallinn Paldiski mnt 50", new String[]{"1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","8.jpg","Joonis (asendiplaan).jpg"});
		session.save(p37);
